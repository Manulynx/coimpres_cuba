...
def home_view(request):
    """Vista para la página de inicio - Con hasta 28 productos para collage máximo"""
    # Obtener hasta 28 productos para el hero collage (máximo optimizado para mobile)
